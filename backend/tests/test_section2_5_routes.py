...
Test runs against: https://culture-connect-2026-1.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://culture-connect-2026-1.preview.emergentagent.com').rstrip('/')

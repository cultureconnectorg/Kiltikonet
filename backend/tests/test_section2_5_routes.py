...
Test runs against: https://terrain-mode-admin.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://terrain-mode-admin.preview.emergentagent.com').rstrip('/')

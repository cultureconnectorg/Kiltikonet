...
Test runs against: https://event-connect-60.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://event-connect-60.preview.emergentagent.com').rstrip('/')

...
Test runs against: https://culture-connect-fix.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://culture-connect-fix.preview.emergentagent.com').rstrip('/')

    ...
    <>
      ...
      {!open && (
        <button onClick={handleOpen} data-testid="cvl-brain-float-btn"
          className="fixed left-1/2 -translate-x-1/2 z-[80] w-14 h-14 rounded-full flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
          style={{ bottom: 'var(--kk-fab-bottom)', background: 'rgba(232,213,160,0.12)', boxShadow: '0 0 32px rgba(232,213,160,0.15), 0 8px 32px rgba(0,0,0,0.5)', backdropFilter: 'blur(16px)' }}
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed left-1/2 -translate-x-1/2 z-[95] rounded-xl overflow-hidden flex flex-col"
          style={{ bottom: 'var(--kk-fab-bottom)', width: 'min(380px, calc(100vw - 2rem))', background: '#131314', boxShadow: '0 24px 80px rgba(0,0,0,0.7), 0 0 40px rgba(232,213,160,0.05)', maxHeight: '520px', border: '1px solid rgba(75,70,59,0.1)' }}
